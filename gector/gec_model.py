...
from gector.utils.helpers import PAD, UNK, get_target_sent_by_edits, START_TOKEN, read_lines
...
class GecBERTModel(object):
    ...
    def correct_file(self, input_file, output_file, batch_size=32):
        ...
        for sent in test_data:
            ...
            if len(batch) == batch_size:
                preds, cnt = self.handle_batch(batch)
